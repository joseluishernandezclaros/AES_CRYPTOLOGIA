...
texto_descifrado = descifrar_aes(texto_cifrado, clave_descifrado)
...
texto_descifrado = ''.join([chr(byte) for byte in texto_descifrado_bytes])

# Imprime el texto descifrado
print("Mensaje descifrado: ", texto_descifrado)

# Imprime mensaje de finalización
print("Paso a paso guardado en 'resultado_aes.txt'")
