...
matriz_referencia_code = [
    ['0', '00', '01', '10', '11'],
    ['00', '1110', '0111', '1001', '1010'],
    ['01', '0100', '1100', '0101', '0110'],
    ['10', '0010', '0001', '0011', '1000'],
    ['11', '1011', '1101', '1111', '0000']
]

matriz_referencia_inverse = [
    ['0', '00', '01', '10', '11'],
    ['00', '1111', '1001', '1000', '1010'],
    ['01', '0100', '0110', '0111', '0001'],
    ['10', '1011', '0010', '0011', '1100'],
    ['11', '0101', '1101', '0000', '1110']
]
...
def proceso(mensaje,clave1,clave2,clave3):
    ...
    def shiftRows(matriz_resultante):
        ...
        matriz_shift[0][0], matriz_shift[0][1] = matriz_shift[0][1], matriz_shift[0][0]
        return matriz_shift
    ...
    print("Mensaje Descrifrado", mensajeDescifrado)
...
print("Arreglo de hexa:", arreglo_hexa)
...
for fila in arreglo_hexadecimal:
    print(fila)
...
print("MENSAJE DESCIFRADO:", cadena)